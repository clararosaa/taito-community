/* Google Material Symbols Rounded: abc (24dp, FILL0 wght400 GRAD0 opsz24). */
export default function Abc({ size = 24 }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
      focusable="false"
      // Glyfi on matala ja jää muiden navi-ikonien rinnalla optisesti
      // pieneksi. Skaalaus ei muuta elementin varaamaa tilaa, joten
      // tekstit pysyvät samalla rivillä.
      style={{ display: 'block', transform: 'scale(1.18)' }}
    >
